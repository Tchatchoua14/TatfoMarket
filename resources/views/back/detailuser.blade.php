        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Détails utilisateurs</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="col-12 col-sm-6 col-md-4 d-flex align-items-stretch flex-column">
              <div class="card bg-light d-flex flex-fill">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    <div class="col-7">
                      <h2 class="lead"><b>Nom et prenom</b></h2>
                ...
                <div class="card-footer">
                  <div class="text-right">
                    <a href="{{ route('formuser') }}" class="btn btn-sm bg-success"> 
              ...
              <div class="card bg-light d-flex flex-fill">
                ...
                <div class="card-body pt-0">
                  <div class="row">
                    ...
                    <div class="col-5 text-center">
                      <img src="assets/dist/img/user2-160x160.jpg" alt="user-avatar" class="img-circle img-fluid">
                    </div>
                  </div>
                </div>
                <div class="card-footer">
