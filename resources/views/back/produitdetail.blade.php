        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{ route('produit') }}">Retour</a></li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="card card-solid">
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-12 col-sm-6">
              <h3 class="my-3">ici c'est le nom du produit</h3>
              <p>ici c'est sa description</p>
              ...
              <h4 class="mt-3">Les tailles disponibles</h4>
              <div class="btn-group btn-group-toggle" data-toggle="buttons">
                <label class="btn btn-default text-center">
              ...
              <div class="bg-gray py-2 px-3 mt-4">
                <h2 class="mb-0">
                  $80.00 son prix unique
                </h2>
                <h4 class="mt-0">
                  <small>Ex Tax: $80.00 les taxes </small>
                </h4>
              </div>

              <div class="mt-4">
                <a href="{{ route('formproduit') }}" class="btn btn-primary btn-lg btn-flat">
                  <i class="fas fa-pencil-alt fa-lg mr-2"></i>
                  Modifier
                </a>
                <form method="POST" action="#">
                        <button class="btn btn-danger btn-lg btn-flat dltBtn" data-id="#"  data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt mr-2"></i> Supprimer</button>
                 </form>
              </div>
          ...
          <div class="row mt-4">
            <nav class="w-100">
              <div class="nav nav-tabs" id="product-tab" role="tablist">
                ...
                <a class="nav-item nav-link" id="product-rating-tab" data-toggle="tab" href="#product-rating" role="tab" aria-controls="product-rating" aria-selected="false">Autre informations supplementaires</a>
              </div>
            </nav>
