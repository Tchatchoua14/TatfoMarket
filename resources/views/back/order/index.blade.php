      ...
      <div class="container-fluid"> 
        <div class="row">
          ...
          @if (session('success'))
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listes de tous les commandes disponibles</h3>
                <div class="card-tools">
             ...
             <table id="example1" class="table table-bordered table-striped dataTable no-footer dtr-inline dt-responsive" aria-describedby="example1_info">
                <thead>
                  <tr>
                    ...
                    <th class="sorting text-center tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="NOM: activate to sort column ascending">User</th>
                    <th class="sorting text-center tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Prénom: activate to sort column ascending">Order_number</th>
                    <th class="sorting text-center tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Quantity</th>
                    ...
                    <th class="sorting text-center tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Roles: activate to sort column ascending">Total_amount</th>
                    <th class="sorting text-center tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Image: activate to sort column ascending">Payement</th>
                  ...
                  <tfoot>
                    <tr>
                        ...
                        <th  class="text-center">Order_number</th>
            ...
            @foreach($orders as $order)   
                <tr class="odd">
                    <td class="dtr-control sorting_1 text-center" tabindex="0">{{$order->id}}</td>
                    <td class="text-capitalize text-center">{{$order->user_id}}</td>
                    <td class="text-capitalize text-center">{{$order->order_number}}</td>
                    <td class="text-capitalize text-center">{{$order->quantity}}</td>
                    <td class="text-center">{{(($order->created_at)? $order->created_at->diffForHumans() : '')}}</td>
