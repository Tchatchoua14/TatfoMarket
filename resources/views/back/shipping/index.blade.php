      ...
      <div class="container-fluid"> 
        <div class="row">
          <div class="col-12 mb-2">
            <a href="{{route('shipping.edit')}}" class="btn btn-success float-right"><i class="fas fa-plus"></i> Créer un shipping</a>
          </div>
          <div class="col-12">
          @if (session('success'))
            <div class="card">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Listes de tous les shippings disponibles</h3>
                <div class="card-tools">
             ...
             <table id="example1" class="table table-bordered table-striped dataTable no-footer dtr-inline dt-responsive" aria-describedby="example1_info">
                <thead>
                  <tr>
                    ...
                    <th class="sorting text-center tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Type</th>
                    <th class="sorting text-center tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Image: activate to sort column ascending">Price</th>
                    <th class="sorting text-center tabindex="0" aria-controls="example1" rowspan="1" colspan="1" aria-label="Roles: activate to sort column ascending">Status</th>
                ...
                <tr class="odd">
                    ...
                    <td class="project-actions d-flex justify-content-around" > 
                        ...
                        <form id="" action="" method="POST">
                          @csrf
                          @method('DELETE') 
                          <button onclick="event.preventDefault(); document.getElementById('destroy{{ $shipping->id }}').submit();" class="btn btn-danger btn-sm  dltBtn" data-id={{$shipping->id}}  data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="fas fa-trash-alt"></i></button>
                        </form>
