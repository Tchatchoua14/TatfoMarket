    ...
    <div id="page-content" class="mt-5">
    	...
    	<div class="collection-header">
			<div class="collection-hero">
        		<div class="collection-hero__image"><img class="blur-up lazyload" data-src="{{ asset('images/cat-women1.jpg') }}" src="{{ asset('images/cat-women1.jpg') }}" alt="Women" title="Women" /></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="#">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="{{ asset('images/product-images/product-image17.jpg') }}" src="{{ asset('images/product-images/product-image17.jpg') }}" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="{{ asset('images/product-images/product-image17-1.jpg') }}" src="{{ asset('images/product-images/product-image17-1.jpg') }}" alt="image" title="product" />
                                            <!-- End hover image -->
                                            <!-- product label -->
                                            <div class="product-labels rounded"><span class="lbl on-sale">Sale</span></div>
                                            <!-- End product label -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-details text-center">
                                        ...
                                        <!-- Variant -->
                                        <ul class="swatches">
                                            <li class="swatch medium rounded"><img src="{{ asset('images/product-images/variant5-1.jpg') }}" alt="image" /></li>
                                            <li class="swatch medium rounded"><img src="{{ asset('images/product-images/variant5-1.jpg') }}" alt="image" /></li>
                                            <li class="swatch medium rounded"><img src="{{ asset('images/product-images/variant5-1.jpg') }}" alt="image" /></li>
                                            <li class="swatch medium rounded"><img src="{{ asset('images/product-images/variant5-1.jpg') }}" alt="image" /></li>
                                        </ul>
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="#">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="{{ asset('images/product-images/product-image20.jpg') }}" src="{{ asset('images/product-images/product-image20.jpg') }}" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="{{ asset('images/product-images/product-image20-1.jpg') }}" src="{{ asset('images/product-images/product-image20-1.jpg') }}" alt="image" title="product" />
                                            <!-- End hover image -->
                                            <!-- product label -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="#">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="{{ asset('images/product-images/product-image21.jpg') }}" src="{{ asset('images/product-images/product-image21.jpg') }}" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="{{ asset('images/product-images/product-image21-1.jpg') }}" src="{{ asset('images/product-images/product-image21-1.jpg') }}" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="#">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="{{ asset('images/product-images/product-image23.jpg') }}" src="{{ asset('images/product-images/product-image23.jpg') }}" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="{{ asset('images/product-images/product-image23-1.jpg') }}" src="{{ asset('images/product-images/product-image23-1.jpg') }}" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item grid-view-item--sold-out">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="#">
                                            <!-- image -->
                                            <img class="grid-view-item__image primary blur-up lazyload" data-src="{{ asset('images/product-images/product-image27.jpg') }}" src="{{ asset('images/product-images/product-image27.jpg') }}" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="grid-view-item__image hover blur-up lazyload" data-src="{{ asset('images/product-images/product-image27-1.jpg') }}" src="{{ asset('images/product-images/product-image27-1.jpg') }}" alt="image" title="product" />
                                            <!-- End hover image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="#">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="{{ asset('images/product-images/product-image32.jpg') }}" src="{{ asset('images/product-images/product-image31.jpg') }}" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="{{ asset('images/product-images/product-image32-1.jpg') }}" src="{{ asset('images/product-images/product-image31-1.jpg') }}" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="#">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="{{ asset('images/product-images/product-image33.jpg') }}" src="{{ asset('images/product-images/product-image31.jpg') }}" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="{{ asset('images/product-images/product-image33-1.jpg') }}" src="{{ asset('images/product-images/product-image31-1.jpg') }}" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="#">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="{{ asset('images/product-images/product-image34.jpg') }}" src="{{ asset('images/product-images/product-image31.jpg') }}" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="{{ asset('images/product-images/product-image34-1.jpg') }}" src="{{ asset('images/product-images/product-image31-1.jpg') }}" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
                                ...
                                <div class="col-6 col-sm-6 col-md-4 col-lg-3 item">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="#">
                                            <!-- image -->
                                            <img class="primary blur-up lazyload" data-src="{{ asset('images/product-images/product-image35.jpg') }}" src="{{ asset('images/product-images/product-image31.jpg') }}" alt="image" title="product" />
                                            <!-- End image -->
                                            <!-- Hover image -->
                                            <img class="hover blur-up lazyload" data-src="{{ asset('images/product-images/product-image35-1.jpg') }}" src="{{ asset('images/product-images/product-image31-1.jpg') }}" alt="image" title="product" />
                                            <!-- End hover image -->
                                        </a>
                                        <!-- end product image -->
