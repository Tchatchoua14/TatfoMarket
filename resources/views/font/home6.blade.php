            	...
            	<div class="container">
                	<div class="row">
                    	<div class="col-12 col-sm-12 col-md-3 col-lg-3">
                        	<div class="img-bnr">
                            	<div class="inner center">
                                	<a href="#">
                                   		<img data-src="{{ asset('images/collection/modern1.jpg') }}" src="{{ asset('images/collection/modern1.jpg') }}" alt="Cap" title="Cap" class="blur-up lazyload" />
                            ...
                            <div class="img-bnr">
                            	<div class="inner center">
                                	<a href="#">
                                   		<img data-src="{{ asset('images/collection/modern2.jpg') }}" src="{{ asset('images/collection/modern2.jpg') }}" alt="Sweaters" title="Sweaters" class="blur-up lazyload" />
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                        	<div class="inner center">
                                <a href="#">
                                    <img data-src="{{ asset('images/collection/modern3.jpg') }}" src="{{ asset('images/collection/modern3.jpg') }}" alt="Tops" title="Tops" class="blur-up lazyload" />
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3">
                        	<div class="inner center">
                                <a href="#">
                                    <img data-src="{{ asset('images/collection/modern4.jpg') }}" src="{{ asset('images/collection/modern4.jpg') }}" alt="Jeans" title="Jeans" class="blur-up lazyload" />
                                    <span class="ttl">Jeans</span>
                                </a>
                            </div>
                            <div class="inner center">
                                <a href="#">
                                    <img data-src="{{ asset('images/collection/modern5.jpg') }}" src="{{ asset('images/collection/modern5.jpg') }}" alt="Shoes" title="Shoes" class="blur-up lazyload" />
                ...
                <div class="row">
                	<!--Featured Item-->
                	 <div class="col-12 col-sm-6 col-md-4 col-lg-4 text-center">
                     	<p>
                           <a href="#">   
                              <img class="blur-up lazyload" data-src="{{ asset('images/collection/modern-fi-1.jpg') }}" src="{{ asset('images/collection/modern-fi-1.jpg') }}" alt="feature-row__image">
                           </a> 
                        </p>
                     ...
                     <div class="col-12 col-sm-6 col-md-4 col-lg-4 text-center">
                     	<p>
                           <a href="#">   
                              <img class="blur-up lazyload" data-src="{{ asset('images/collection/modern-fi-2.jpg') }}" src="{{ asset('images/collection/modern-fi-2.jpg') }}" alt="feature-row__image">
                           </a> 
                        </p>
                     ...
                     <div class="col-12 col-sm-6 col-md-4 col-lg-4 text-center">
                     	<p>
                           <a href="#">   
                              <img class="blur-up lazyload" data-src="{{ asset('images/collection/modern-fi-3.jpg') }}" src="{{ asset('images/collection/modern-fi-3.jpg') }}" alt="feature-row__image">
                           </a> 
                        </p>
