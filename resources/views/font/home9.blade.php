    ...
    <div id="page-content" class="mt-5">
        	...
        	<div class="home-slideshow">
            	<div class="slide">
                	<div class="blur-up lazyload">
                        <img class="blur-up lazyload" data-src="{{ asset('images/slideshow-banners/home9-banner1.jpg') }}" src="{{ asset('images/slideshow-banners/home9-banner1.jpg') }}" alt="Gift For her" title="Gift For her" />
        ...
        <div class="section">
        	<div class="hero hero--large hero__overlay bg-size">
            	<img class="bg-img blur-up" src="{{ asset('images/parallax-banners/home9-parallax-banner1.jpg') }}" alt="" />
        ...
        <div class="section">
        	<div class="hero hero--large hero__overlay bg-size">
            	<img class="bg-img" src="{{ asset('images/parallax-banners/home9-parallax-banner2.jpg') }}" alt="" />
				<div class="hero__inner">
                    <div class="container">
                    	<div class="wrap-text  left text-large font-bold">
                          <h2 class="h2 mega-title">The mid season SALE.<br>UP TO 50% OFF</h2>
                          <div class="rte-setting mega-subtitle">Live life Comfortable.<br>This flip flops switch, flip &amp; reverse to make up to 246 combos!<p><b>FREE SHIPPING on all orders over $199</b></p></div>
        ...
        <div class="section">
        	<div class="hero hero--large hero__overlay bg-size">
            	<img class="bg-img" src="{{ asset('images/parallax-banners/home9-parallax-banner3.jpg') }}" alt="" />
				<div class="hero__inner">
                    <div class="container">
