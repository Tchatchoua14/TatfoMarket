    ...
    <style>
     #pe{
      background-image:url("{{ asset('images/product-detail-page/variant1-1.jpg') }}");
     }
     #pe1{
        background-image:url("{{ asset('images/product-detail-page/variant1-2.jpg') }}");
     }
     #pe2{
        background-image:url("{{ asset('images/product-detail-page/variant1-3.jpg') }}"); 
    }
    #pe3{
        background-image:url("{{ asset('images/product-detail-page/variant1-4.jpg') }}"); 
    }
    </style>
    <footer id="footer">
                	...
                	<div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 footer-links">
                            ...
                            <ul>
                                ...
                                <li><a href="{{route('contact.create')}}">{{ __('message.home.var7') }}</a></li>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="product-details-img">
                            <div class="pl-20">
                                <img src="{{ asset('images/product-detail-page/camelia-reversible-big1.jpg') }}" alt="" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="swatch clearfix swatch-0 option1" data-option-index="0">
                                    <div class="product-form__item">
                                      ...
                                      <div data-value="Red" class="swatch-element color red available">
                                        ...
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-red" id="pe" title="Red"></label>
                                      </div>
                                      <div data-value="Blue" class="swatch-element color blue available">
                                        <input class="swatchInput" id="swatch-0-blue" type="radio" name="option-0" value="Blue">
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-blue" id="pe1" title="Blue"></label>
                                      </div>
                                      <div data-value="Green" class="swatch-element color green available">
                                        <input class="swatchInput" id="swatch-0-green" type="radio" name="option-0" value="Green">
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-green" id="pe2" title="Green"></label>
                                      </div>
                                      <div data-value="Gray" class="swatch-element color gray available">
                                        <input class="swatchInput" id="swatch-0-gray" type="radio" name="option-0" value="Gray">
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-gray" id="pe3" title="Gray"></label>
                                      </div>
                                    </div>
                                </div>
